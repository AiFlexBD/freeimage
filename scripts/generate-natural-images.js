...
const missingCategories = [
  { id: 'oil-painted', name: 'Oil Painted', target: 50, current: 0 }
];
...
const naturalPrompts = {
  ...
  'pixel-art': [
    ...
    "Peaceful pixel art scene with a knight and friendly dragon sharing a meal in a cozy tavern. Classic RPG art style with warm lighting and friendship theme",
    ...
    "Retro pixel art spaceship peacefully exploring an asteroid field with colorful rocks and distant stars in the background. Classic space adventure art style with vibrant colors and cosmic wonder",
    "Pixel art wizard studying ancient books in a mystical library with floating books and crystals. Fantasy 8-bit art with magical atmosphere and peaceful study scene",
    ...
    "Friendly pixel art scene showing a large robot helping a small character build something in a futuristic workshop. Classic arcade game art with cooperation and teamwork theme",
    ...
    "Retro pixel art treasure room with stone walls, torches, treasure chests, and golden coins creating an adventurous atmosphere. Classic RPG art style with exploration and discovery",
    ...
    "Peaceful pixel art scene with giant robots working together to build a city with construction equipment and teamwork. Classic mecha art style with cooperation and building theme",
    "Cute pixel art of a magical girl with sparkles and colorful effects, standing in a flower field. 8-bit art style with magical transformation and vibrant colors",
    "Retro pixel art racing car parked in a neon-lit garage with colorful lights and racing equipment. Classic arcade racing art with speed and excitement",
    ...
    "Peaceful pixel art space scene with multiple ships exploring asteroids and space stations with colorful lights and cosmic wonder. Classic space adventure art with exploration theme",
    ...
    "Retro pixel art of a ninja character walking through a bamboo forest with moonlight filtering through leaves. Classic stealth game art with shadows and peaceful atmosphere"
  ],
  architecture: [
...
const uniqueTitles = {
  ...
  'pixel-art': [
    ...
    "Cyberpunk City Neon",
    "Village River Night",
    "Knight Dragon Friendship",
    "Cat Snow Window",
    "Spaceship Asteroid Field",
    "Wizard Study Library",
    "Garden Pond Koi",
    "Robot Helper Workshop",
    "Robot Cat Friends",
    "Treasure Room Discovery",
